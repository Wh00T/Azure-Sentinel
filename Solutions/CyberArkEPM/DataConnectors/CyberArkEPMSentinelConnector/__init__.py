...
use_saml_auth = os.environ.get['UseSAMLAuth']
identity_tenant_url = os.environ.get['IdentityTenantURL']
identity_tenant_id = os.environ.get['IdentityTenantID']
identity_appkey = os.environ.get['IdentityAppKey']
